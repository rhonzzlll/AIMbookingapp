                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      {facilities.map((facility) => (
                        <FacilityCard
                          ...
                          imageSrc={facility.buildingImage || '/placeholder-building.png'}
              ...
              <div className="flex flex-col text-gray-500 text-sm mt-1">
                {booking.changedBy && (
                  <div className="flex items-center">
                   ...
                   Processed by:  {booking.changedBy}
                  </div>
                )}
  ...
  return (
    <div className="bg-white text-gray-800 rounded-xl shadow-sm overflow-hidden hover:shadow-md transition-shadow">
      <div className="h-48 overflow-hidden relative">
        ...
        {/* Use placeholder image if imageSrc is not available or fails to load */}
        <img
          src={imgError || !imageSrc ? '/placeholder-building.png' : imageSrc}
          alt={title}
...
const getImageByName = (imageName) => {
  // Replace AIMImage with a valid placeholder image
  const placeholderImage = '/placeholder-building.png'; // Path to your placeholder image
  if (!imageName || imageName === 'AIMImage') {
    return placeholderImage; // Return placeholder if imageName is undefined or invalid
  }
